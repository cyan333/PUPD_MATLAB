...
error_10k1 = error_sim_10k1./(1-delta_t./t1_2);
...
axis([900 1000000 0.1 50]);
xticks([1000 10000 900000]);
...
loglog(Rfsr, error_sim_10k2,'b--', 'LineWidth',2);
%%%% Rref = 10k No Extra Cap - Err vs R %%%%%
hold on
